...
const MenuPage = () => {
    ...
    return (
        <>
            <Helmet><title>Menu || Mamta Bhojnalaya Restaurant</title></Helmet>
            <SectionCover image={banner} heading={'Explore Our Menu'} subHeading={"Mamta Bhojnalaya is a culinary canvas where flavors dance harmoniously. Their menu is a symphony of diverse ingredients, each dish a masterpiece painted with passion and creativity."}></SectionCover>

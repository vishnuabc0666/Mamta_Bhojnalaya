...
const Dashboard = () => {
    ...
    return (
        ...
        <>
            <Helmet><title>Dashboard | Mamta Bhojnalaya Restaurent</title></Helmet>
            <div className="drawer lg:drawer-open">
                ...
                <div className="drawer-content overflow-x-auto">
                    <div className="navbar bg-black bg-opacity-80 lg:hidden px-5">
                        <div className="flex-1">
                            <Link to="/" style={{ fontFamily: 'Domine', }} className="text-white hover:text-warning font-semibold"><p><span className='text-sm'>Mamta&nbsp;Bhojnalaya</span> <br /> <span className='text-lg'>RESTAURANT</span></p></Link>
                        </div>
                ...
                <div className="drawer-side">
                    ...
                    <ul className="menu p-4 w-56 min-h-full bg-yellow-600 space-y-1">
                        ...
                        <Link to="/" style={{ fontFamily: 'Domine', }} className="text-white hover:text-warning font-semibold my-8"><p><span className='text-sm'>Mamta&nbsp;Bhojnalaya</span> <br /> <span className='text-lg'>RESTAURANT</span></p></Link>
                        {
                            isAdmin ? <>
